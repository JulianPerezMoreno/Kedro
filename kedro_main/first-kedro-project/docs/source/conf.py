...
# first_kedro_project documentation build
...
from first_kedro_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "first_kedro_project"
author = "Kedro"
...
htmlhelp_basename = "first_kedro_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "first_kedro_project.tex",
        "first_kedro_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "first_kedro_project",
        "Project first_kedro_project codebase.",
        "Data-Science",
    )
]
